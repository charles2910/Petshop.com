...
async function updateProduto(produto){
    ...
    await estoque.get(produto.codigo).then(async (headers)=>{
        await estoque.destroy(produto,headers._rev);
...
module.exports = {validaLogin,removeProduto,updateProduto,updateUser,criarDb,destruirDb,getBanner,addUser, findUser, addProduto, findProduto, findProdutos, buscaProduto, addAgendamento, findAgendamento, addServico, getServicos};
