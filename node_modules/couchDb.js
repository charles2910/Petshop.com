...
module.exports = {validaLogin,carregarBanners,removeProduto,updateProduto,updateUser,criarDb,destruirDb,getBanner,addUser, findUser, addProduto, findProduto, findProdutos, buscaProduto, addAgendamento, findAgendamento, addServico, getServicos};
...
async function buscaProduto(inicio,txt){
    if(txt!=undefined){
        ...
        retorno = retorno.slice(inicio*16,(inicio+1)*16);
        console.log(retorno.length,inicio);
        return new Lista(txtOriginal,txtOriginal,3,banners["geral1"],retorno,qtdTotalpaginas,inicio);
    }
}
...
module.exports = {validaLogin,updateServico,carregarBanners,removeProduto,updateProduto,updateUser,criarDb,destruirDb,getBanner,addUser, findUser, addProduto, findProduto, findProdutos, buscaProduto, addAgendamento, findAgendamento, addServico, getServicos};
